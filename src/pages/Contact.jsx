...
const contactSchema = z.object({
  name: z.string().trim().min(1, "Name can't be empty").max(100, "Max. Characters is 100"),
  email: z.string().trim().email("Invalid Email").max(255, "Max. Characters is 255"),
  message: z.string().trim().min(1, "Message can't be empty").max(1000, "Max. Characters is 1000"),
});
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Message Sent! ✨",
        description: "Thankyou for reaching out. I'll get back to you soon.",
      });
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Got Interest? Feel free to drop me a line below.
            </p>
          </div>
